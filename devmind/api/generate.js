...
- If no URLs are provided use: https://loremflickr.com/800/500/{topic}
...
export default async function handler(req) {
  ...
  try {
    ...
    try {
      ...
      console.log("Groq failed, trying OpenRouter:", groqErr.message);
    }
    ...
    const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
      ...
      headers: {
        ...
        "HTTP-Referer": "https://devmind-ide.vercel.app",
        "X-Title": "DevMind IDE",
      },
      body: JSON.stringify({
